<?php
if(count($sprachen) == 0) {
    include(PRDYZ_DIR_LANG.$language.'/lang.inc.host_raumkampf.php');
} else {
    foreach($sprachen as $sprache) {
        include(PRDYZ_DIR_LANG.$sprache.'/lang.inc.host_raumkampf.php');
    }
}
