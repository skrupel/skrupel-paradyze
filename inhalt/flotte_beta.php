        ...
        <script type="text/javascript">
            function checken() {
                ...
                if (($fracht_lemin>=1) or ($planet_lemin>=1)) {
                    ?>
                    document.formular.fracht_lemin.value=(s.getValue()-<?php echo $fracht_lemin+$planet_lemin; ?>)*-1;
                    document.formular.planet_lemin.value=s.getValue();
                    <?php
                } else {
                    ?>
                    document.formular.fracht_lemin.value=0;
                    document.formular.planet_lemin.value=0;
                    <?php
                }
                if ($infanterie!=1) {
                ...
                var lemin= eval(document.formular.schiff_lemin.value+'+0');
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        ...
                        <input type="hidden" name="s_leichtebt" value=0>
                        <input type="hidden" name="p_leichtebt" value=0>
                        <input type="hidden" name="fracht_vorrat" value=0>
                        <input type="hidden" name="planet_vorrat" value=0>
                        <input type="hidden" name="fracht_lemin" value=0>
                        <input type="hidden" name="planet_lemin" value=0>
                        <?php 
                        if ($infanterie==1) {
                            ?>
                            ...
                            <input type="hidden" name="fracht_cantox" value='<?php echo $fracht_cantox?>'>
                            <input type="hidden" name="planet_cantox" value='<?php echo $planet_cantox; ?>'>
                            <input type="hidden" name="fracht_min1" value='<?php echo $fracht_min1?>'>
                            <input type="hidden" name="planet_min1" value='<?php echo $planet_min1; ?>'>
                            <input type="hidden" name="fracht_min2" value='<?php echo $fracht_min2?>'>
                            <input type="hidden" name="planet_min2" value='<?php echo $planet_min2; ?>'>
                            <input type="hidden" name="fracht_min3" value='<?php echo $fracht_min3?>'>
                            <input type="hidden" name="planet_min3" value='<?php echo $planet_min3; ?>'>
                            <?php
                        } else {
                            ?>
                            <input type="hidden" name="fracht_leute" value=0>
                            <input type="hidden" name="planet_kolonisten" value=0>
                            <input type="hidden" name="s_schwerebt" value=0>
                            <input type="hidden" name="p_schwerebt" value=0>
                            <input type="hidden" name="fracht_cantox" value=0>
                            <input type="hidden" name="planet_cantox" value=0>
                            <input type="hidden" name="fracht_min1" value=0>
                            <input type="hidden" name="planet_min1" value=0>
                            <input type="hidden" name="fracht_min2" value=0>
                            <input type="hidden" name="planet_min2" value=0>
                            <input type="hidden" name="fracht_min3" value=0>
                            <input type="hidden" name="planet_min3" value=0>
                            <?php
                        }
                        ?>
                    </td>
