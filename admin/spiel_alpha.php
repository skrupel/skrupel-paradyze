...
?>
<center><br><br>Der Name eines Spiels muss mindestens 5 Zeichen lang sein.<br><br><a href="javascript:history.back()">Zur&uuml;ck</a></center>
<?php
		include ("inc.footer.php");
		exit();
      }
...
<?php
   if ($conf_enable_ai == true) $gefundene_KIs = array();
