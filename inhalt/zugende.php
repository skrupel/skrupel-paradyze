...
?>
    <body text="#000000" bgcolor="#444444" style="background-image:url('<?php
        echo $bildpfad
?>/aufbau/14.gif'); background-attachment:fixed;" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
...
?>
                        <td>
                            <center><a href="zugende.php?fu=7&uid=<?php
            echo $uid
?>&sid=<?php
            echo $sid
?>&sprache=<?php
            echo $_GET["sprache"]
?>" target="_self"><img src="<?php
            echo $bildpfad
?>/menu/gsprung.gif" width="75" height="75" border="0"><br><nobr><?php
            echo $lang['zugende']['galaxiesprung']
?></nobr></a></center>
                        </td>
                        <?php
        }
?>
                    <td>
                        <center><a href="zugende.php?fu=2&uid=<?php
        echo $uid
?>&sid=<?php
        echo $sid
?>&sprache=<?php
...
?>" target="_top"><img src="<?php
        echo $bildpfad
?>/menu/logout.gif" width="75" height="75" border="0"><br><nobr><?php
        echo $lang['zugende']['logout']
?></nobr></a></center>
                    </td>
                    <?php
...
?>
                        <td>
                            <center><a href="zugende.php?fu=3&uid=<?php
            echo $uid
?>&sid=<?php
            echo $sid
?>&sprache=<?php
...
?>" target="_self"><img src="<?php
            echo $bildpfad
?>/menu/abschliessen.gif" width="75" height="75" border="0"><br><nobr><?php
            echo $lang['zugende']['zugabschliessen']
?></nobr></a></center>
                        </td>
                        <?php
        }
...
?>/aufbau/14.gif'); background-attachment:fixed;" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" height="100%" cellspacing="0" cellpadding="0">
                <tr>
                        <td><nobr><center><?php
        echo $lang['zugende']['abgeschlossen']
?></center></nobr></td>
                </tr>
            </table>
        </center>
...
?>
    <script language="JavaScript">
        ...
        function redir() {
            link('uebersicht_uebersicht.php?fu=1&uid=<?php
        echo $uid
?>&sid=<?php
        echo $sid
?>&sprache=<?php
        echo $_GET["sprache"]
?>');
            window.location='uebersicht.php?fu=1&uid=<?php
        echo $uid
?>&sid=<?php
        echo $sid
?>&sprache=<?php
...
?>';
        ...
        <body onload="javascript:redir();" text="#000000" bgcolor="#444444" style="background-image:url('<?php
        echo $bildpfad
?>/aufbau/14.gif'); background-attachment:fixed;" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" height="100%" cellspacing="0" cellpadding="0">
                <tr>
                <td><nobr><center><?php
        echo $lang['zugende']['wurdenausgewertet']
?></center></nobr></td>
                </tr>
            </table>
        </center>
    ...
    if ($fuid == 6) {
        include('inc.header.php');
?>
    <body onLoad="window.location='zugende.php?fu=5&uid=<?php
        echo $uid
?>&sid=<?php
        echo $sid
?>&sprache=<?php
        echo $_GET["sprache"]
?>';" text="#000000" bgcolor="#444444" style="background-image:url('<?php
        echo $bildpfad
?>/aufbau/14.gif'); background-attachment:fixed;"  link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" cellspacing="0" cellpadding="0" height="100%">
                <tr>
                    <td>
                        ...
                        <img src="<?php
        echo $bildpfad
?>/radd.gif" height="46" width="51">
                            <br><br>
                            <?php
        echo $lang['zugende']['wirdberechnet']
?>
                        </center>
                    </td>
                </tr>
    ...
    if ($fuid == 7) {
        include('inc.header.php');
?>
    <body text="#ffffff" style="background-image:url('<?php
        echo $bildpfad
?>/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
        ...
        echo $lang['zugende']['galaxiesprung']
?></center></td>
                    <td><a href="javascript:hilfe();"><img src="<?php
        echo $bildpfad
?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                </tr>
            </table>
        </center>
        <center>
            <table border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                    <td><form name="formular" method="post" action="zugende.php?fu=8&uid=<?php
        echo $uid
?>&sid=<?php
        echo $sid
?>&sprache=<?php
...
?>
                ...
                <tr>
                    <td></td>
                    <td><center><input type="submit" name="bla" value="<?php
        echo $lang['zugende']['sprungdurchfuehren']
?>" style="width:250px;"></center></td>
                    <td></form></td>
                </tr>
            </table>
        </center>
...
?>
    <script language=JavaScript>
        ...
        function galaxiewechsel() {
            parent.mittelinksoben.window.location = 'menu.php?fu=1&uid=<?php
        echo $uid
?>&sid=<?php
        echo $sidneu
?>&sprache=<?php
        echo $_GET["sprache"]
?>';
            parent.untenlinks.window.location     = 'menu.php?fu=2&uid=<?php
        echo $uid
?>&sid=<?php
        echo $sidneu
?>&sprache=<?php
...
?>';
    ...
    <body onload="javascript:galaxiewechsel();" text="#000000" bgcolor="#444444" style="background-image:url('<?php
        echo $bildpfad
?>/aufbau/14.gif'); background-attachment:fixed;" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" cellspacing="0" cellpadding="0" height="100%">
                <tr>
                    <td><center><?php
        echo $lang['zugende']['spunginitialisiert']
?></center></td>
                </tr>
            </table>
        </center>
