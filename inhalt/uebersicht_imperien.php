		...
		<td><?php echo $text?></td>
                                    ...
                                    <center>
                                        <table border="0" cellspacing="2" cellpadding="5" width="100%">
                                            <tr>
                                                <td width="100%" colspan="2"><img src="../lang/<?php echo $_GET["sprache"]?>/topics/dieimperien.gif" border="0" width="185" height="52"></td>
                                            ...
                                            for ($k=1;$k<11;$k++) {
                                                if ($spieler_id_c[$k]>=1) {
                                                    ...
                                                    ?>
                                                        <td style="border-top: 1px solid gray;"><a href="meta_rassen.php?fu=2&uid=<?php echo $uid?>&sid=<?php echo $sid?>&rasse=<?php echo$spieler_rasse_c[$k]?>&sprache=<?php echo $_GET["sprache"]?>"><img src="../daten/<?php echo $spieler_rasse_c[$k]?>/bilder_allgemein/menu.png" width="186" height="75" border="0"></a></td>
                                                        <td style="border-top: 1px solid gray; color:<?php echo $spielerfarbe[$k]?>;font-size:12px;" width="100%"><?php echo $spieler_rassename_c[$k]?><? if ($spieler==$k) {?> <a href="uebersicht_imperien.php?fu=2&spid=<?php echo $spieler?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>&sprache=<?php echo $_GET["sprache"]?>" style="font-size:9px;">(<?php echo $lang['uebersichtimperien']['edit']?>)</a><?php }?><br><br><nobr><a href="uebersicht_imperien.php?fu=4&spid=<?php echo $spieler_id_c[$k]?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>&sprache=<?php echo $_GET["sprache"]?>"><?php echo $username?></a></nobr></td>
                                                        <td style="border-top: 1px solid gray; font-size:11px;"><nobr><center><?php echo $spieler_basen_c[$k]?>.</center></nobr></td>
                                                        <td style="border-top: 1px solid gray; font-size:11px;"><nobr><center><?php echo $spieler_planeten_c[$k]?>.</center></nobr></td>
                                                        <td style="border-top: 1px solid gray; font-size:11px;"><nobr><center><?php echo $spieler_schiffe_c[$k]?>.</center></nobr></td>
                                                        <td style="border-top: 1px solid gray; font-size:12px;"><nobr><b><center><?php echo $spieler_gesamt_c[$k]; ?>.</center></b></nobr></td>
                                                    </tr><?php
                                                }
                                            }
                                            ?>
...
<body text="#ffffff" bgcolor="#444444"  link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<center>
	<br><? if ($avatar) {?><img src="<?=$avatar?>"><?} ?><br>
	<table cellpadding="5" cellspacing="2" border="0" width="30%">
	   <tr>
		<th colspan="2" style="text-align: left;"><b><?=$nick?></b></th>
	   </tr>
	   <tr>
		<td width="50%" style="border-top: 1px solid gray;"><b>ICQ</b></td>
		<td width="50%" style="border-top: 1px solid gray; text-align: center;"><?=$icq?><? if ($icq) {?><img src="http://web.icq.com/whitepages/online?icq=<?=$icq?>&img=5"><?} else {?>&nbsp;<?}?></td>
	   </tr>
	   <tr>
		<td width="50%" style="border-top: 1px solid gray;"><b>Spiele</b></td>
		<td width="50%" style="border-top: 1px solid gray; text-align: center;"><?=$stat_teilnahme?></td>
	   </tr>
	   <tr>
		<td width="50%" style="border-top: 1px solid gray;"><b>Gewonnene Spiele</b></td>
		<td width="50%" style="border-top: 1px solid gray; text-align: center;"><?=$stat_sieg?></td>
	   </tr>
	   <tr>
		<td width="50%" style="border-top: 1px solid gray;"><b>Schlachten</b></td>
		<td width="50%" style="border-top: 1px solid gray; text-align: center;"><?=$stat_schlacht?></td>
	   </tr>
	   <tr>
		<td width="50%" style="border-top: 1px solid gray;"><b>Gewonnene Schlachten</b></td>
		<td width="50%" style="border-top: 1px solid gray; text-align: center;"><?=$stat_schlacht_sieg?></td>
	   </tr>
	   <tr>
		<td width="50%" style="border-top: 1px solid gray;"><b>Kolonien</b></td>
		<td width="50%" style="border-top: 1px solid gray; text-align: center;"><?=$stat_kol_erobert?></td>
	   </tr>
	   <tr>
		<td width="50%" style="border-top: 1px solid gray;"><b>Lichtjahre</b></td>
		<td width="50%" style="border-top: 1px solid gray; text-align: center;"><?=$stat_lichtjahre?></td>
	   </tr>
	   <tr>
		<td width="50%" style="border-top: 1px solid gray;"><b>Monate</b></td>
		<td width="50%" style="border-top: 1px solid gray; text-align: center;"><?=$stat_monate?></td>
	   </tr>
	</table>
</center>
            <?php
