...
$lang['hilfe']['ueberschrift'][48]='Begleitschutz';
$lang['hilfe']['text'][48]="Ein Schiff kann jederzeit als Begleitschutz eines anderen Schiffes abkommandiert werden. Dabei wird bei der Mission das andere Schiff, sowie die Warpgeschwindigkeit eingestellt. Sobald die Spezialmission aktiviert wurde, versucht nun dieses Schiff dem anderen zu folgen und befindet sich irgendwann, wenn es schnell genug fliegt, jederzeit an der gleichen Position. Dieser automatische Begleitschutz ist allerdings eine <b>defensive Mission</b>. Sollte das zu beschützende Schiffe einen Angriff auf ein feindliches Schiff fliegen, so hinkt der Begleitschutz nach und nimmt <b>nicht an diesem Angriff</b> teil.";

$lang['hilfe']['ueberschrift'][49]='Schiff übergeben';
$lang['hilfe']['text'][49]="Mit dieser Spezialmission lässt sich ein Schiff an einen anderen Spieler übergeben.";

$lang['hilfe']['ueberschrift'][50]='Akademieausbildung';
$lang['hilfe']['text'][50]="Die Akademieausbildung ermöglicht es Schiffen die sich im Orbit eines Planeten mit Kampfstation und Jägerakademie befinden, innerhalb von 5 Monaten um ein Erfahrungslevel zu steigern. Die Ausbildung kostet je Schiff:
<ul>
<li>100 Cantox</li>
<li>10 Vorräte</li>
<li>50 Lemin</li>
...
<ul>
<li>höchstens Lukyshot und Overdrive als Spezialmission besitzen</li>
<li>deren Masse kleiner ist als 100</li>
</ul>
Die Schiffe dürfen sich wärend der 5 monatigen Ausbildungszeit nicht bewegen, und müssen die Gebühren mitführen.";

$lang['hilfe']['ueberschrift'][51]='Crew anheuern';
$lang['hilfe']['text'][51]="Geht Crew durch normale oder durch Kaperangriffe verloren, so wird die Crew um die eingestellte Zahl ergänzt. Dies funktioniert aber nur an eigenen Sternenbasen!";

$lang['hilfe']['ueberschrift'][52]='Overdrive';
$lang['hilfe']['text'][52]="Bei aktiviertem Overdrive bewegt sich das Schiff um den eingestellten Wert (z.B. 30%) weiter als normal. Der Overdrive versagt mit der gleichen Wahrscheinlichkeit, mit der das Triebwerk übersteuert wird. Der Overdrive benötigt im Gegensatz zum Übertakten des Antriebs keinen zusätzlichen Treibstoff.";

$lang['hilfe']['ueberschrift'][53]='Destabilisator';
$lang['hilfe']['text'][53]="Der Destabilisator ist ein Superlaser, der mit einer Effektivität von 95% einen Planeten destabilisieren und somit zum kollabieren bringen kann.";

$lang['hilfe']['ueberschrift'][54]='Signaturmaskierung';
$lang['hilfe']['text'][54]="Diese Spezialmission startet die Signaturmaskierung.";

$lang['hilfe']['ueberschrift'][55]='Virale Invasion';
$lang['hilfe']['text'][55]="Anstatt eines Planetenbombardements, sind Schiffe mit dieser Spezialmission in der Lage in die Athmosphäre der Planeten einzutauchen und speziell angepasste Kampfstoffe (biologisch / nanotechnologisch) freizusetzen. Es kann frei entschieden werden, ob der Stoff die feindlichen Kolonisten oder die dominate Spezies des Planeten angreifen soll. Wie erfolgreich die Mission sein kann, ist den entsprechenden Schiffsbeschreibungen zu entnehmen.";

$lang['hilfe']['ueberschrift'][56]='Minenfeld räumen';
$lang['hilfe']['text'][56]="Mit dieser Spezialmission räumt ein Schiff ein bestimmtes Minenfeld.";

$lang['hilfe']['ueberschrift'][57]='Minenfeld legen';
$lang['hilfe']['text'][57]="Mit dieser Spezialmission legt ein Schiff ein Minenfeld.";

$lang['hilfe']['ueberschrift'][58]='Kaperangriff';
$lang['hilfe']['text'][58]="Alle Waffensysteme haben 2 Werte. Der normale alte Wert bestimmt den Schaden am Rumpf. Der neue zweite Wert, gibt an wie gross der Schaden innerhalb der Crew bei zerstörten Schilden pro Treffer ist. Um also die Crew zu treffen müssen zuerst die Schilde mit konventionellem Schaden durchdrungen werden! Stirbt die Crew des Schiffes vollständig wird das Schiff vom Feind übernommen. Über die neue Spezialmission 'Kaperangriff' lassen sich die beiden Kampfwerte beeinflussen. Ist sie gesetzt, senkt sich der normale Schadenwert um 50% und es erhöht sich der Schaden gegen die feindliche Crew um 25%.";

$lang['hilfe']['ueberschrift'][59]='Lloyds Fluchtmanöver';
$lang['hilfe']['text'][59]="Mittels Slipstream ist das Schiff in der Lage jederzeit direkt und ohne Verbrauch zu seinen Schaffungskoordinaten springen. Eventuell nimmt es dabei Schaden. Diese Angabe befindet sich in der entsprechenden Schiffbeschreibung. ";

$lang['hilfe']['ueberschrift'][60]='Cybernrittnikk';
$lang['hilfe']['text'][60]="Mittels Cyberittnikk ist das Schiff in der Lage aus Vorrat Replikatoren zu produzieren.";

$lang['hilfe']['ueberschrift'][61]='Hermetische Matrix';
$lang['hilfe']['text'][61]="Mit einer aktivierten hermetischen Matrix ist ein Schiff in der Lage einen Transwarptunnel zusammenbrechen zu lassen. Nach dem Durchfliegen sind die beiden Ausgangspunkt (Sprungtor bzw. Wurmloch) nicht mehr miteinander verbunden und somit instabil. ";

$lang['hilfe']['ueberschrift'][62]='Drugun-Umsetzer';
$lang['hilfe']['text'][62]="Der Drugun-Umsetzer.";

$lang['hilfe']['ueberschrift'][63]='Schilddämpfer';
$lang['hilfe']['text'][63]="Bei aktiviertem Schilddämpfer werden die Schutzschilde des Feindschiffes im Raumkampf umgangen. Pro Kampf verbraucht der Dämpfer 10 Rennurbin pro 100 Masse des gegnerischen Schiffes. Der Dämpfer wirkt nur auf das aktuelle gegnerische Schiff während eines Kampfes. Für andere Schiffe die nachher oder vorher kämpfen oder bekämpft werden sind die Schilde wieder intakt.";

$lang['hilfe']['ueberschrift'][64]='Gravitationswellen-Generator';
$lang['hilfe']['text'][64]="Schiffe mit dieser Technologie können ein 65 Lichtjahre großes Abfangfeld generieren. Feindliche Schiffe, die darin versuchen Sprungtriebwerk oder Lloyds Fluchtmanöver zu starten, bzw. das Feld per Hypersprung durchqueren, werden gestoppt. Ausserdem werden im Feld sämtliche Schiffsbewegungen auf Warp 7 beschränkt. Zur Aufrechterhaltung des Feldes wird pro Runde eine gewisse Menge Vomisaan benötigt, diese ist der Schiffsbeschreibung zu entnehmen.";

$lang['hilfe']['ueberschrift'][65]='Orbitale Systeme';
$lang['hilfe']['text'][65]="Als Orbitale Systeme bzw. Globale Systeme bezeichnet man Institutionen oder Anlagen, die auf Planeten gebaut werden können. Ein Planet verfügt über 1 bis 6 freie Slots um solche Systeme zu bauen. Man sollte vor dem Bau aber daran denken, dass es zur Zeit keine Möglichkeit gibt, gebaute Systeme wieder zu entfernen.<br><br>Man unterscheidet bei den Globalen Systemen zwischen aktiven und passiven. Die Aktiven lassen sich direkt anklicken, um bestimmte Aktionen auszuführen, die Passiven bewirken von sich heraus etwas.";

$lang['hilfe']['ueberschrift'][66]='Musikplayer';
$lang['hilfe']['text'][66]="Dieser Player untermalt das Spiel mit Sci-Fi-Musik, um das Spielerlebnis noch spannender zu gestalten. Er kann aber auch über die Optionen jederzeit ein- und ausgeschaltet werden.<br>
<br>
Diese Musik wird derzeit verwendet:<br>
<b>1.</b> softspace - Time Traveler <i>(CC BY-SA 3.0)</i><br>
<b>2.</b> remaxim - Dark Fallout <i>(CC BY-NC-SA 3.0)</i>";

$lang['hilfe']['ueberschrift'][67]='Sternenbasen';
$lang['hilfe']['text'][67]="Es gibt 4 verschiedene Typen von Basen. Im Spiel beginnt man Standardmässig mit einer Basis vom Typ Sternenbasis. ";
?>