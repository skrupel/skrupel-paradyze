...
if ($fuid==2) {
    ...
    <html>
        <head>
            ...
            <?php /* stehen lassen!
            <link href="js/flexcroll/flexcrollstyles.css" rel="stylesheet" type="text/css" />
        ...
        <body style="background-color: #111111; border: 0;" onLoad="move_sticky();" scroll="auto"  TEXT="#ffffff" LINK="#000000" VLINK="#000000" ALINK="#000000" topmargin="0" leftmargin=0 marginwidth="0" marginheight="0">
        <?php /* stehen lassen!
        <div id="completegallery" class='flexcroll' style="position:relative;height:100%;width:100%;top:0px;bottom:0px;left:0px;right:0px;overflow:auto;">
        */ ?>
			...
			if (ie) {
                ...
                <script language=JavaScript>movemap(<?php echo $start_map_x.','.$start_map_y; ?>);</script>
                <?php
