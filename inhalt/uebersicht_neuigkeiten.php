        ...
        if ($anzahl>=1) {
            ...
            <script language=JavaScript>
                function gefecht(art,sh1,sh2,datum) {
                    ...
                    window.open('gefecht_text.php?fu='+art+'&sh1='+sh1+'&sh2='+sh2+'&datum='+datum+'&uid=<?=$uid?>&sid=<?=$sid?>','Gefecht','resizable=yes,scrollbars=yes,width=450,height=350,top='+oben+',left='+links);
                }
            </script>
            <?php 
            $tag=date('d',time());
