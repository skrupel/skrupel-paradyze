...
<?php
	...
	//}elseif ($_GET["fu"]==7) { da unnötig, nur kopf
	}elseif ($_GET["fu"]==8) {
		?>
		<center>
			<table border="0" cellspacing="0" cellpadding="2">
		...
		<?php 
		echo $lang['hilfe'][8][9];
	//}elseif ($_GET["fu"]==9) { da unnötig, nur kopf
	}elseif ($_GET["fu"]==10) {
		?>
		<center>
			<table border="0" cellspacing="0" cellpadding="2">
		...
		<?php
	//}elseif ($_GET["fu"]==11) { da unnötig, nur kopf
	}elseif ($_GET["fu"]==12) {
		?>
		<center>
		...
		<?php
	//}elseif ($_GET["fu"]==13 bis 15 ) { unnötig, nur kopf
	}elseif ($_GET["fu"]==16) {
		?>
		<ul>
			<?php
	...
	//}elseif ($_GET["fu"]==17 bis 32) { unnötig, nur kopf
	}elseif ($_GET["fu"]==33) {
		?>
		<center>
			<table border="0" cellspacing="0" cellpadding="2">
