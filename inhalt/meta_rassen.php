            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                while ($file=readdir($handle)) {
                    if ((substr($file,0,1)<>'.') and (substr($file,0,7)<>'bilder_') and (substr($file,strlen($file)-4,4)<>'.txt')) {
                        ...
                        ?>
                        <td>&nbsp;</td><td><a href="javascript:;" border="0" onclick="link('meta_rassen.php?fu=2&uid=<?php echo $uid?>&sid=<?php echo $sid?>&rasse=<?php echo $file?>&sprache=<?php echo $_GET["sprache"]?>');body.focus();"><img src="../daten/<?php echo $file?>/bilder_allgemein/menu.png" border="0" width="186" height="75"></a></td>
                        <?php
                    }
                }
                closedir($handle);
...
if ($_GET["fu"]==2) {
    ...
    <script type="text/javascript" src="js/helpers/swfobject.js"></script>
        <?php /* <div id="metas" class='flexcroll' style="position:relative;height:100%;width:100%;overflow:auto;"> */ ?>
        <?php
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="20"><img src="../bilder/empty.gif" border="0" width="1" height="30"></td>
            </tr>
            <?php
            for ($i=0;$i<$zaehler;$i++) {
