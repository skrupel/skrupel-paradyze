        ...
        <body text="#ffffff" style="background-image:url('<?php echo $bildpfad; ?>/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            <center>
                <table border="0" cellspacing="0" cellpadding="3">
                    <tr>
                        <td colspan="3" align="center" height="50px"><b>Administration</b></td>
                    </tr>
                    <tr>
<?php if ($ziel_id==0) { ?>
						<td>
...
///////////////////////////////////////////////////////////////////////////////////////////////RASSENEIGENSCHAFTEN ENDE
            ...
            }elseif ($klasse==4) { $bild=rand(1,14);  //Klasse L warm nur wenig Wasseroberfl&auml;che
            }elseif ($klasse==5) { $bild=rand(1,11);  //Klasse G W&uuml;stenplanet
            ...
            }elseif ($klasse==9) { $bild=rand(1,9);}    //Klasse F jung zerkl&uuml;ftet
