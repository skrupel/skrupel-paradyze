...
<center><table border="0" cellspacing="0" cellpadding="4"><tr><td style="font-size:20px; font-weight:bold; filter:DropShadow(color=black, offx=2, offy=2)"><?php echo $lang['admin']['spiel']['beta']['optionen']?></td></tr></table></center>
   ...
   <tr><td><table border="0" cellspacing="0" cellpadding="0">
	...
	<?php for($p=1;$p<21;$p++){ ?>
		<option value="<?php echo $percentage_list[$p]?>"><?php echo str_replace('{1}',$percentage_list[$p],$lang['admin']['spiel']['beta']['vh']);?></option>
	<?php } ?>
    </select></td></tr>
	...
	<?php for($p=3;$p<13;$p++){ ?>
		<option value="<?php echo $percentage_list[$p]?>"><?php echo str_replace('{1}',$percentage_list[$p],$lang['admin']['spiel']['beta']['runden']);?></option>
	<?php } ?>
    </select></td></tr>
      </table></td></tr>
