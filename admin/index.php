...
<head>
    ...
    <title><?php echo $conf_meta_title; ?> | Administration</title>
    ...
    <td><table border="0" cellspacing="0" cellpadding="0" background="../bilder/login.gif">
             ...
             <tr>
                ...
                <td valign="top"><center>
                    <img src="../bilder/empty.gif" border="0" width="1" height="80"><br>
                    <img src="../bilder/logo.png"><br>
                    <img src="../bilder/empty.gif" border="0" width="1" height="50"><br>
