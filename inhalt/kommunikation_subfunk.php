                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="empfang">
                                            ...
                                            <?php
                                            $zahl=0;
                                            $array_spieler=array('',$spieler_1,$spiele_2,$spieler_3,$spieler_4,$spieler_5,$spieler_6,$spieler_7,$spieler_8,$spieler_9,$spieler_10);
                                            for($i=1;$i<11;$i++){
                                                if (($module[4]==0) or ($begegnung[1]==1)) {
...
if ($_GET["fu"]==3) {
    ...
    include ("inc.header.php");
    ?>
    <body text="#FFFFFF" bgcolor="#000000" scroll="no" link="#CCCCCC" vlink="#CCCCCC" alink="#CCCCCC" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <table height="100%" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
