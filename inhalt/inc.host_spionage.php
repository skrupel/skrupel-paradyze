...
if($module[0]) {
    if(count($sprachen) == 0) {
        include(PRDYZ_DIR_LANG.$language.'/lang.inc.host_spionage.php');
        include(PRDYZ_DIR_LANG.$language.'/lang.spionagen.php');
        ...
        foreach($sprachen as $sprache) {
            include(PRDYZ_DIR_LANG.$sprache.'/lang.inc.host_spionage.php');
            include(PRDYZ_DIR_LANG.$sprache.'/lang.spionagen.php');
