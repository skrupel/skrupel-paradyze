...
if ($_GET["fu"]==1) {
    ...
    <body text="#000000" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td><a href="javascript:;" border="0" onclick="link_unten('kommunikation.php?fu=1&uid=<?php echo $uid?>&sid=<?php echo $sid?>&sprache=<?php echo $_GET["sprache"]?>');self.focus();"><img src="<?=$bildpfad?>/aufbau/menu_3.gif" border="0" width="57" height="46"  title="<?php echo $lang['menu']['kommunikation']?>"></a></td>
            </tr>
            <tr>
...
if ($_GET["fu"]==2) {
    ...
    <body text="#000000" bgcolor="#000000" background="<?php echo $bildpfad?>/aufbau/13.gif" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td><a href="javascript:;" border="0" onclick="link_unten('zugende.php?fu=1&uid=<?php echo $uid?>&sid=<?php echo $sid?>&sprache=<?php echo $_GET["sprache"]?>');self.focus();"><img src="<?php echo $bildpfad?>/aufbau/knopp.gif" border="0" width="56" height="30" title="<?=$lang['menu']['zugende']?>"></a></td>
            </tr>
        </table>
    <?php include ("inc.footer.php");
} ?>
