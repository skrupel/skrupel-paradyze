...
<input type="hidden" name="spiel_name" value="<?=$_POST["spiel_name"]?>">
<input type="hidden" name="siegbedingungen" value="<?=$_POST["siegbedingungen"]?>">
<input type="hidden" name="zielinfo_1" value="<?=$_POST["zielinfo_1"]?>">
<input type="hidden" name="zielinfo_2" value="<?=$_POST["zielinfo_2"]?>">
<input type="hidden" name="zielinfo_3" value="<?=$_POST["zielinfo_3"]?>">
<input type="hidden" name="zielinfo_4" value="<?=$_POST["zielinfo_4"]?>">
<input type="hidden" name="zielinfo_5" value="<?=$_POST["zielinfo_5"]?>">
<input type="hidden" name="user_1" value="<?=$_POST["user_1"]?>">
<input type="hidden" name="user_2" value="<?=$_POST["user_2"]?>">
<input type="hidden" name="user_3" value="<?=$_POST["user_3"]?>">
<input type="hidden" name="user_4" value="<?=$_POST["user_4"]?>">
<input type="hidden" name="user_5" value="<?=$_POST["user_5"]?>">
<input type="hidden" name="user_6" value="<?=$_POST["user_6"]?>">
<input type="hidden" name="user_7" value="<?=$_POST["user_7"]?>">
<input type="hidden" name="user_8" value="<?=$_POST["user_8"]?>">
<input type="hidden" name="user_9" value="<?=$_POST["user_9"]?>">
<input type="hidden" name="user_10" value="<?=$_POST["user_10"]?>">
<input type="hidden" name="rasse_1" value="<?=$_POST["rasse_1"]?>">
<input type="hidden" name="rasse_2" value="<?=$_POST["rasse_2"]?>">
<input type="hidden" name="rasse_3" value="<?=$_POST["rasse_3"]?>">
<input type="hidden" name="rasse_4" value="<?=$_POST["rasse_4"]?>">
<input type="hidden" name="rasse_5" value="<?=$_POST["rasse_5"]?>">
<input type="hidden" name="rasse_6" value="<?=$_POST["rasse_6"]?>">
<input type="hidden" name="rasse_7" value="<?=$_POST["rasse_7"]?>">
<input type="hidden" name="rasse_8" value="<?=$_POST["rasse_8"]?>">
<input type="hidden" name="rasse_9" value="<?=$_POST["rasse_9"]?>">
<input type="hidden" name="rasse_10" value="<?=$_POST["rasse_10"]?>">
<input type="hidden" name="spieler_admin" value="<?=$_POST["spieler_admin"]?>">
<input type="hidden" name="startposition" value="<?=$_POST["startposition"]?>">
<input type="hidden" name="imperiumgroesse" value="<?=$_POST["imperiumgroesse"]?>">
<input type="hidden" name="geldmittel" value="<?=$_POST["geldmittel"]?>">
<input type="hidden" name="mineralienhome" value="<?=$_POST["mineralienhome"]?>">
<input type="hidden" name="sternendichte" value="<?=$_POST["sternendichte"]?>">
<input type="hidden" name="mineralien" value="<?=$_POST["mineralien"]?>">
<input type="hidden" name="spezien" value="<?=$_POST["spezien"]?>">
<input type="hidden" name="max" value="<?=$_POST["max"]?>">
<input type="hidden" name="wahr" value="<?=$_POST["wahr"]?>">
<input type="hidden" name="lang" value="<?=$_POST["lang"]?>">
<input type="hidden" name="instabil" value="<?=$_POST["instabil"]?>">
<input type="hidden" name="stabil" value="<?=$_POST["stabil"]?>">
<input type="hidden" name="leminvorkommen" value="<?=$_POST["leminvorkommen"]?>">
<input type="hidden" name="umfang" value="<?=$_POST["umfang"]?>">
<input type="hidden" name="struktur" value="<?=$_POST["struktur"]?>">
<input type="hidden" name="modul_0" value="<?=$_POST["modul_0"]?>">
<input type="hidden" name="modul_2" value="<?=$_POST["modul_2"]?>">
<input type="hidden" name="modul_3" value="<?=$_POST["modul_3"]?>">
<input type="hidden" name="out" value="<?=$_POST["out"]?>">
<input type="hidden" name="nebel" value="<?=$_POST["nebel"]?>">

<input type="hidden" name="piraten_mitte" value="<?=$_POST["piraten_mitte"]?>">
<input type="hidden" name="piraten_aussen" value="<?=$_POST["piraten_aussen"]?>">
<input type="hidden" name="piraten_min" value="<?=$_POST["piraten_min"]?>">
<input type="hidden" name="piraten_max" value="<?=$_POST["piraten_max"]?>">


<? if ($_POST["siegbedingungen"]==6) {  ?>
<input type="hidden" name="team1" value="<?=$_POST["team1"]?>">
<input type="hidden" name="team2" value="<?=$_POST["team2"]?>">
<input type="hidden" name="team3" value="<?=$_POST["team3"]?>">
<input type="hidden" name="team4" value="<?=$_POST["team4"]?>">
<input type="hidden" name="team5" value="<?=$_POST["team5"]?>">
<input type="hidden" name="team6" value="<?=$_POST["team6"]?>">
<input type="hidden" name="team7" value="<?=$_POST["team7"]?>">
<input type="hidden" name="team8" value="<?=$_POST["team8"]?>">
<input type="hidden" name="team9" value="<?=$_POST["team9"]?>">
<input type="hidden" name="team10" value="<?=$_POST["team10"]?>">
<? } ?>
<center>
<br><br>
<img src="http://spaze.iceflame.net/bilder/rad.gif" height="46" width="51">
<br><br>
Bitte warten...
</center>
</form>
...
$a = random_char();$e = random_char();$i = random_char();$m = random_char();$q = random_char();
$b = random_char();$f = random_char();$j = random_char();$n = random_char();$r = random_char();
$c = random_char();$g = random_char();$k = random_char();$o = random_char();$s = random_char();
$d = random_char();$h = random_char();$l = random_char();$p = random_char();$t = random_char();
...
$zeiger = @mysql_query("INSERT INTO skrupel_spiele (sid,name,module,out,start) values ('$sid','$spielname','$module',$out," . time() . ")");
...
$daten_verzeichnis=$conf_root_path."/daten/";
...
$file=$conf_root_path.'daten/dom_spezien.txt';
$fp = @fopen("$file","r");
if ($fp) {
while (!feof ($fp)) {
    $buffer = @fgets($fp, 4096);
...
$file=$conf_root_path.'daten/bilder_galaxien/'.$struktur.'.txt';
$fp = @fopen("$file","r");
if ($fp) {
$zaehler=0;
while (!feof ($fp)) {
...
$planetenname=@file($conf_root_path.'daten/planetennamen.txt');
...
//for ($i=0;$i<50;$i++) {
  ...
  if ($klasse==4) { $bild=rand(1,14);$temp=rand(50,75); }  //Klasse L warm nur wenig Wasseroberfl�che
  if ($klasse==5) { $bild=rand(1,11);$temp=rand(86,100); }  //Klasse G W�stenplanet
  ...
  if ($klasse==9) { $bild=rand(1,9);$temp=rand(25,45); }    //Klasse F jung zerkl�ftet
...
$file=$conf_root_path.'daten/gala_strukturen.txt';
$fp = @fopen("$file","r");
if ($fp) {
while (!feof ($fp)) {
    $buffer = @fgets($fp, 4096);
...
function sichtaddieren($sicht_alt,$sicht_neu) {
  ...
  $dateiinclude=$conf_root_path."/inhalt/inc.host_nebel.php";
