    ...
    if ($antrieb==0) {
        ...
        <script language=JavaScript>
            function rechnen(e) {
                ...
                <?php echo(jsArrayFromArray("verbrauchpromonat",getVerbrauchProMonat($antrieb))); ?>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(64);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(63);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(62);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(61);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><?php echo $lang['flottealpha']['auto']; ?></td>
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(60);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(59);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(58);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(57);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(56);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(55);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(54);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(53);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(52);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(51);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(50);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                    <td><a href="javascript:hilfe(49);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                            ...
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td><img src="../bilder/empty.gif" border="0" width="3" height="1"></td>
                                        <td><a href="javascript:hilfe(48);"><img src="<?php echo $bildpfad; ?>/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                    </tr>
                                </table>
                            </td>
                            <td></td>
